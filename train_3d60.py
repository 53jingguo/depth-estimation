...
from trainer_3d60 import Trainer
# from trainer_paste3d60 import Trainer
...
# ablation settings
parser.add_argument("--net", type=str, default="sphfuse", choices=["UniFuse","convnext","sphfuse"], help="model to use")
parser.add_argument("--fusion", type=str, default="cee", choices=["cee", "cat", "biproj"],
                    help="the method to fuse sph features to equirectangular features")
