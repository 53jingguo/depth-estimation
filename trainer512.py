...
import datasets
from networks import  Equi_convnext_tea, SphFuse512
from metrics import compute_depth_metrics, Evaluator
from losses import BerhuLoss, RMSELog
...
class Trainer:
    def __init__(self, settings):
        ...
        val_file_list = fpath.format(self.settings.dataset, "test")
    ...
    def train(self):
        ...
        # self.validate()
        for self.epoch in range(2, self.settings.num_epochs):
    ...
    def process_batch(self, inputs):
        ...
        if self.train_coarse:
            outputs = self.model(equi_inputs, Lut512,Lut128,Lut64,Lut32)
    ...
    def validate(self):
        ...
        # self.model_stu.eval()
        self.model_tea.eval()
        saver = Saver('D:\\project\\UniFuse-Unidirectional-Fusion-main\\UniFuse-Unidirectional-Fusion-main\\UniFuse\\experiments_s2d3d_8\\')
        ...
        self.evaluator.print(self.epoch, 'D:\\project\\UniFuse-Unidirectional-Fusion-main\\UniFuse-Unidirectional-Fusion-main\\UniFuse\\experiments_s2d3d_8\\')
        del inputs, outputs
    ...
    def load_tea(self):
        ...
        """
        load_weights_dir = os.path.expanduser("D:\\project\\UniFuse-Unidirectional-Fusion-main\\UniFuse-Unidirectional-Fusion-main\\UniFuse\\experiments_tea_s2d3d_8\\panodepth\\models\\weights_2\\")
