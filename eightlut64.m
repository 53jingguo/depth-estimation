...
f=imresize(f,[64,128]);   % if the origional image is too large, you can resize the image. ****Maybe you don't need it****
[h,w,td]=size(f);
rImg=zeros(h,w,td);
pai=3.14159;
kk=1;

yita = 360/128*(pi/180)*2;
...
%             x_new=-1;
%         else
        x_new = (x_new - 63.5)/63.5;
        y_new = (y_new - 31.5)/31.5;
...
str=strcat('G:\liujingguo\LUT\2LUT64\LUT_left_down.mat');
save(str,'LUT')
kk=kk+1;